ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :hunts, :member => {:answered => :get, :question_overview => :get, :results => :get, :completed => :get, :invite_players => :get, :add_players => :put, :play => :get} do |hunts|
  ...
  map.resources :site, :collection => {:help=> :get, :project => :get, :team => :get, :about => :get, :help => :get}
